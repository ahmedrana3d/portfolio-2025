...
export const Timeline = ({
  ...
  return (
    <div
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20 md:pb-24 lg:pb-32">
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <AnimatedText className="hidden md:block">
                <h3
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <AnimatedText className="md:hidden block mb-4">
                <h3
                  className="text-2xl text-left font-bold text-neutral-500 dark:text-neutral-500">
                  {item.title}
                </h3>
              </AnimatedText>
              <AnimatedText>
